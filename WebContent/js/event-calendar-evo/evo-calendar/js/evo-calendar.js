...
(function(factory) {
    ...
    EvoCalendar.prototype.buildEventList = function() {
        ...
        if (!hasEventToday) {
            if (_.$active.date === _.$current.date) {
                markup = '<p>No evento por hoy... Así que descansa!</p>';
            } else {
                markup = '<p>No hay evento este día</p>';
            }
        }
    ...
    EvoCalendar.prototype.addEventIndicator = function(active_date, type) {
        var _ = this,
            htmlToAppend, thisDate = _.$elements.innerEl.find('[data-date-val="' + active_date + '"]');
    ...
    EvoCalendar.prototype.toggleOutside = function(event) {
        var _ = this,
            hasSidebar, hasEvent, isInnerClicked;
